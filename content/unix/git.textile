...
* Start an interactive rebase with <code>git rebase -i [commit]^</code>, where [commit] is the commit you want to split. In fact, any commit range will do, as long as it contains that commit.

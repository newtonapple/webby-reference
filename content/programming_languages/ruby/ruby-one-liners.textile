---
browser_title:  Ruby One-Liners
title:          Ruby One-Liners
name:           Ruby One-Liners
created_at:     2008-12-20 13:54:33.013248 -08:00
filter:
  - wikiwords
  - erb
  - textile
...
"Source":http://www.fepus.net/ruby1line.txt
...
<% uv :lang => 'shell-unix-generic' do -%>
  # human readable sort: http://www.codinghorror.com/blog/archives/001018.html
  ["aa123.txt", "ka023.rb", "ka098.rb", "ka98", "a2.txt"].sort_by{ |item| item.to_s.split(/(\d+)/).map { |e| [e.to_i, e] } } 
      #=> ["a2.txt", "aa123.txt", "ka023.rb", "ka098.rb", "ka98"]
  # The code utilize <=>'s ability to sort / give total order to array
...
h2. Text Conversion and Substitution
...
h2. Selective Printing of Certain Lines
...
h2. Selective Deletion of Certain Lines
